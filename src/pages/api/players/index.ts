...
export const POST: APIRoute = async ({ request }) => {
  try {
    ...
    const player = await createPlayer({
      ...
      height: data.height,
      heightCm: data.heightCm === undefined || data.heightCm === '' ? undefined : Number(data.heightCm),
      weight: data.weight,
      weightKg: data.weightKg === undefined || data.weightKg === '' ? undefined : Number(data.weightKg),
      image: data.image,
      bio: data.bio,

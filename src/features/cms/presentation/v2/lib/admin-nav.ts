...
export const ADMIN_NAV: AdminNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'League Seasons', href: '/admin/leagues', icon: Trophy, permission: 'leagues:read' },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: '/admin/highlights/potw',
        icon: Star,
        permission: 'potw:read',
      },
      {
        label: 'Sponsors',
        href: '/admin/highlights/sponsors',
        icon: Handshake,
  ...
  },
  {
    label: 'Assets',
    items: [
      { label: 'Media Library', href: '/admin/media', icon: Images, permission: 'media:read' },
    ],
  },
  {
    label: 'System',

...
import { createReportGeneration, updateReportGeneration } from '../../data/datasources/mutations';
import { getDefaultReportTemplate } from '../../data/datasources/queries';
...
export async function generateReport(
  ...
  try {
    ...
    let template = null;
    if (input.templateId) {
      const { getReportTemplate } = await import('../../data/datasources/queries');

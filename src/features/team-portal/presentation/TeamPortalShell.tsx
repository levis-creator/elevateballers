      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="sticky top-0 z-30 border-b border-white/[0.06] bg-[#111010] px-4 py-3 min-[900px]:px-7 min-[900px]:py-4">
          <div className="mx-auto flex max-w-[1180px] items-center gap-3">
            ...
            <a href="/api/auth/logout" className="flex h-9 items-center gap-2 rounded-xl border border-white/[0.08] bg-white/[0.03] px-3 text-[12px] font-bold text-[#b8afa6] no-underline min-[900px]:hidden"><LogOut size={14} strokeWidth={1.8} />Exit</a>
          </div>
        </header>

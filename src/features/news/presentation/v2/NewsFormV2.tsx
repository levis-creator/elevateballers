...
const RichTextEditor = lazy(() =>
  import('../../../cms/presentation/components/NewsEditor').then((module) => ({ default: module.RichTextEditor }))
);

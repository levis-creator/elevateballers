...
const StandingsTable = ({ standings }) => {
    ...
    () => [
      ...
      },
      {
        ...
        cell: (info) => {
          ...
          return team.url ? /* @__PURE__ */ jsx("a", { href: team.url, children: team.team }) : team.team;
        },
  ...
  return /* @__PURE__ */ jsx("div", { className: "sp-template sp-template-league-table", children: /* @__PURE__ */ jsx(
    DataTable,
    {
      data: standings,
      columns,

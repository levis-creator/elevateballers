...
async function seedSiteSettings() {
  ...
  const settings = [
    ...
    { key: 'rules_page_title', value: 'League Rules & Regulations', type: 'text', label: 'Rules Page Title', category: 'rules' },
    { key: 'rules_page_intro', value: 'Read the official Elevate Ballers rules and regulations. You can view the document online or download the latest PDF.', type: 'textarea', label: 'Rules Page Intro', category: 'rules' },
    { key: 'rules_pdf_url', value: '/documents/elevate-ballers-league-rules-2026.pdf', type: 'url', label: 'Rules PDF URL', category: 'rules' },
    { key: 'rules_download_label', value: 'Download Rules PDF', type: 'text', label: 'Rules Download Button Label', category: 'rules' },

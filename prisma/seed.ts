 ...
 * Seed seasons
 */
async function seedSeasons(leagues: any[]) {
  console.log('\n📅 Seeding seasons...');
 ...
 */
async function seedMatches(teams: any[], leagues: any[], seasons: any[]) {
  console.log('\n⚽ Seeding matches...');
  ...
  for (let i = 0; i < 20; i++) {
    ...
    matches.push({
      ...
      seasonId: season.id,
      stage: random(['REGULAR_SEASON', 'PLAYOFF', 'QUARTER_FINALS', 'SEMI_FINALS', 'CHAMPIONSHIP'] as const),
    });
  }

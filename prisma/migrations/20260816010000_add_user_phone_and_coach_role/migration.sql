...
SELECT 'role-team-coach', 'Team Coach', 'Manages one or two clubs: their roster, staff and team profile. Sees nothing belonging to another club.', true, NOW(3), NOW(3)
